...
#define stringOriginalFilename	"StackOverflowFx.vst3"
#if SMTG_PLATFORM_64
#define stringFileDescription	"StackOverflowFx VST3 (64Bit)"
#else
#define stringFileDescription	"StackOverflowFx VST3"
#endif
#define stringCompanyName		"My Plug-in Company\0"
#define stringLegalCopyright	"Copyright(c) 2022 My Plug-in Company."
